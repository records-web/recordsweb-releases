# RecordsWeb 3.4.3 — image-only Discord login DMs

RecordsWeb 3.4.3 keeps the Discord integration entirely in the Supabase `recordsweb-discord` Edge Function.
...
```powershell
supabase secrets set RECORDSWEB_VERSION="3.4.3" --project-ref cdakocrmfstsknbgugkc
