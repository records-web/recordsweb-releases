-- ============================================================================
-- RecordsWeb 3.4.0 — FULL REQUIRED DATABASE UPDATE
-- ============================================================================
--
...
--   • v3.4.0 Discord Bot community integration and staff Discord User IDs
--
-- FIX INCLUDED:
...
-- Run as a separate transaction because the preceding 3.3.9 consolidated file
-- already closes its transaction.
-- ============================================================================
...
create index if not exists profiles_discord_user_id_idx
  on public.profiles(discord_user_id) where discord_user_id is not null;
