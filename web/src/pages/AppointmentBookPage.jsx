...
export default function AppointmentBookPage() {
  ...
  return <div className="page-pad workspace-page">
    <div className="page-title-row"><div><h1>Appointment Book</h1><p>Clinic schedule for {ORGANISATION.name}.</p></div><button className="primary-button" onClick={()=>setEditing({starts_at:`${date}T09:00`})}><Plus size={15}/> Book appointment</button></div>
